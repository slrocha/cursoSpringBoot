...
public class ClienteController {
    ...
    @ResponseBody //para carregar no corpo da pagina, ja que estamos trabalhando com api e nao paginas web
    ...
    @ResponseBody //o que vem na requiscao
    ...
    @PutMapping("/api/clientes/{id}") //quando for atualizar um recurso no servidor
    @ResponseBody
